...
class TvFloating extends StatelessWidget {
  const TvFloating({super.key});

  @override
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context
          .read<FloatingItemsBloc>()
          .add(const FloatingItemsEvent.initial2());
    });
    return Scaffold(
          ...
          builder: (context, state) {
            ...
            return Padding(
              ...
              child: GridView.count(
                ...
                children: List.generate(state.getTvData.length, (index) {
                  final postar = state.getTvData[index].postarPath;
                  return Container(
                    height: 180,
                    width: 120,
